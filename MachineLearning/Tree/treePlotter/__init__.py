...
def plotNode(nodeTxt, centerPt, parentPt, nodeType):
   createPlot.ax1.annotate(nodeTxt, fontproperties='SimHei', xy=parentPt, xycoords='axes fraction', \
                           xytext=centerPt, textcoords='axes fraction', va="center", ha="center", \
                           bbox=nodeType, arrowprops=arrow_args, fontsize=16)
...
def plotMidText(cntrPt, parentPt, txtString):
   ...
   createPlot.ax1.text(xMid, yMid, txtString, fontproperties='SimHei', fontsize=14)
